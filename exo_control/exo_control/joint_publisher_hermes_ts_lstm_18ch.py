...
# ============================================================
#  Hermes exoskeleton — Timestamp next-tick LSTM publisher, ALL PLANES (18ch)
#
#  Trained by timestamps_LSTM_all_planes.py. No phase variable / foot
#  contact FSM here — this is a plain rolling-window next-tick predictor
#  driven purely by the angle history.
#
...
# ============================================================
class JointPublisherHermesTSLSTM18ch(Node):
    def __init__(self):
        super().__init__("joint_publisher_hermes_ts_lstm_18ch")
        ...
        # Files produced by timestamps_LSTM_all_planes.py
        model_file = "Timestamp_lstm_next_tick_model_18.keras"
        scaler_file = "standard_scaler_typical_lstm_next_tick_18.save"
        # 18 cols: <18 angles in training order>
        excel_file = "timestamps_cp_lstm_18ch.xlsx"
        # ================================
        ...
        self.get_logger().info("Loaded Timestamp (18ch) next-tick LSTM model + scaler.")
...
def main(args=None):
    ...
    node = JointPublisherHermesTSLSTM18ch()
