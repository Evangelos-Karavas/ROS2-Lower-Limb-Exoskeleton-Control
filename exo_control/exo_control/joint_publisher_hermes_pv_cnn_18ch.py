...
# ============================================================
#  Hermes exoskeleton — PV next-tick CNN publisher, ALL PLANES (18ch)
#
#  Trained by phase_variable_cnn_all_planes.py. The model predicts all
...
# ============================================================
class JointPublisherHermesPVCNN18ch(Node):
    def __init__(self):
        super().__init__("joint_publisher_hermes_pv_cnn_18ch")
        ...
        # Files produced by phase_variable_cnn_all_planes.py
        model_file = "PV_cnn_best_rollout_dtw_18ch.keras"
        scaler_pv_file = "scaler_pv_cnn_18ch.save"
        scaler_ang_file = "scaler_angles_cnn_18ch.save"
        # 20 cols: [PhaseVariable_Left, PhaseVariable_Right, <18 angles in training order>]
        excel_file = "PV_cp_cnn_18ch.xlsx"
        # ================================
        ...
        self.get_logger().info("Loaded PV (18ch) next-tick CNN model + scalers.")
...
def main(args=None):
    ...
    node = JointPublisherHermesPVCNN18ch()
