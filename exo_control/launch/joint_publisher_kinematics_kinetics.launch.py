...
def generate_launch_description():
    ...
    urdf_path = PathJoinSubstitution([exo_description_pkg, 'urdf', 'lleap_exo_kinetics.urdf.xacro'])
    controllers_config = PathJoinSubstitution([exo_control_pkg, 'config', 'ros2_controller_kinetics.yaml'])
    ...
    return LaunchDescription([
        ...
        TimerAction(
            ...
            actions=[
                Node(
                    package='exo_control',
                    executable='joint_publisher_kinematics_kinetics',
